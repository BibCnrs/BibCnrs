export const AIDS_RESULTS_EXPECTED = {
	results: [
		{
			id: 1,
			...
			articleLinks: {
				...
				urls: [
					{
						name: "Availability",
						url: "http://hdl.handle.net/10520/EJC168622",
					},
				],
			},
			exportLinks: {},
			...
			source:
				"African Journal of Reproductive Health, Mar 2015, Vol 19, Issue 1, p. 63-72.",
			authors: ["Owusu, Samuel Asiedu"],
			publicationDate: new Date("2015-03-01T00:00:00.000Z"),
			languages: ["English"],
			database: "SA ePublications Service",
			subjects: [
				"Children",
				"Perception",
				"HIV and AIDS",
		...
		},
		{
			...
			exportLinks: {},
			doi: null,
			title: "Integrating Children's Literature in Elementary Mathematics",
			source:
				"Online Submission, Paper presented at the Annual Meeting of the Georgia Educational Research Association (Savannah, GA, Oct 16-17, 2015). 27 pp.",
			authors: ["Thomas, Lynsey", "Feng, Jay"],
			publicationDate: new Date("2015-10-01T00:00:00.000Z"),
			languages: ["English"],
			database: "ERIC",
			subjects: [
		...
		},
		{
			...
			source:
				"Journal of Speech, Language, and Hearing Research. Oct 2015, Vol. 58 Issue 5, p1611, 15 p.",
			authors: [
				"Walker, Elizabeth A.",
				"Holte, Lenore",
				"McCreery, Ryan W.",
			...
			subjects: [
				...
				"Hearing disorders in children -- Research",
		...
		},
		{
			...
			articleLinks: {
				...
				urls: [
					{
						name: "Availability",
						url: "http://library.cqpress.com/cqpac/document.php?id=hsdc99-0000038544",
					},
				],
			},
			exportLinks: {},
			...
			source: "Historic Documents of 1999.",
			authors: null,
			publicationDate: new Date("2000-01-01T00:00:00.000Z"),
			languages: null,
			database: "CQ Press Public Affairs Collection",
			subjects: [
				"AIDS & HIV",
				"Health",
				"Research & Advocacy",
			...
			publicationType: "Primary Source",
			abstract: null,
		},
		{
			id: 5,
			...
			source: "Journal of Education and Practice, v6 n29 p92-101 2015. 10 pp.",
			authors: ["Ohwojero, Chamberlain Joseph"],
		...
		},
		{
			...
			source: "AIDS and Behavior. August 2015, Vol. 19 Issue 8, p1408, 7 p.",
			authors: [
				"Thurman, Tonya R.",
				"Kidman, Rachel",
				"Nice, Johanna",
			...
			publicationDate: new Date("2015-08-01T00:00:00.000Z"),
			languages: ["English"],
			database: "Academic OneFile",
			subjects: [
				"Children -- Behavior",
		...
		},
		{
			...
			source:
				"International Journal of Medical Science and Public Health. June 2015, Vol. 4 Issue 6, p773, 4 p.",
			authors: [
				"Thakor, Nilesh",
				"Gadhavi, Rajendra N.",
				"Damor, Pradip",
			...
			publicationDate: new Date("2015-06-01T00:00:00.000Z"),
			languages: ["English"],
			database: "Academic OneFile",
			subjects: [
				"Disease transmission -- Research",
				"HIV infection in children -- Distribution",
			...
			publicationType: "Academic Journal",
			abstract:
				"Abstract Background: Acquired immunodeficiency syndrome (AIDS) has emerged as one of the most serious public health problems in India. Objectives: This study was conducted (1) to study the sociodemographic profile [...]",
		},
		{
			id: 8,
			...
			articleLinks: {
				...
				fullTextLinks: [
					{
						name: "Voir le texte intégral en SciELO",
			...
			source:
				"Brazilian Journal of Otorhinolaryngology. Apr 2015 81(2):148-157",
			authors: [
				"Leticia Macedo, Penna",
				"Stela Maris Aguiar, Lemos",
				"Cláudia Regina Lindgren, Alves",
			],
			publicationDate: new Date("2015-04-01T00:00:00.000Z"),
			languages: ["English"],
			database: "SciELO",
			subjects: [
				"Hearing loss / Perda auditiva",
				"Child language / Linguagem infantil",
				"Hearing aids / Auxiliares de audição",
		...
		},
		{
			...
			source: "UNICEF. 124 pp.",
			authors: ["United Nations Children's Fund (UNICEF)"],
			publicationDate: new Date("2014-11-01T00:00:00.000Z"),
			languages: ["English"],
			database: "ERIC",
			subjects: [
				"Children",
			...
			publicationType: "Numerical/Quantitative Data; Reports - Descriptive",
			abstract:
		...
		},
		{
			...
			source:
				"International Journal of Pediatric Otorhinolaryngology. April 2015, Vol. 79 Issue 4, p541, 5 p.",
			authors: [
				"Baudonck, N.",
				"Van Lierde, K.",
				"D'Haeseleer, E.",
		...
		},
		{
			...
			source: "World Journal of AIDS. Vol. 4 Issue 1, p27-37. 11 p.",
			authors: [
				"Dickson Shey Nsagha",
			...
			publicationDate: new Date("2014-03-01T00:00:00.000Z"),
			languages: ["英文"],
			database: "Airiti Library eBooks & Journals - 華藝線上圖書館",
			subjects: [
				"Orphans",
				"Vulnerable",
				"Children",
		...
		},
		{
			...
			source:
				"Journal of the Association of Nurses in AIDS Care. July-August, 2015, Vol. 26 Issue 4, p432, 11 p.",
			authors: ["Thornton, Clifton P.", "Veenema, Tener Goodwin"],
			publicationDate: new Date("2015-07-01T00:00:00.000Z"),
			languages: ["English"],
			database: "Academic OneFile",
		...
		},
		{
			...
			source: "World Development. Dec 2015, Vol. 76, p344, 15 p.",
			authors: ["Han, Lu", "Koenig-Archibugi, Mathias"],
			publicationDate: new Date("2015-12-01T00:00:00.000Z"),
			languages: ["English"],
			database: "Academic OneFile",
			subjects: ["Developing countries -- Analysis"],
			publicationType: "Academic Journal",
			abstract:
		...
		},
		{
			...
			source: "RGO - Revista Gaúcha de Odontologia. Mar 2015 63(1):07-12",
			authors: [
		...
		},
		{
			...
			source: "AIDS and Behavior. Nov 2015, Vol. 19 Issue 11, p2130, 10 p.",
			authors: [
				"Chi, Peilian",
				"Li, Xiaoming",
				"Tam, Cheuk Chi",
			...
			publicationDate: new Date("2015-11-01T00:00:00.000Z"),
			languages: ["English"],
			database: "Academic OneFile",
			subjects: [
				"Caregivers -- Research",
				"Caregivers -- Health aspects",
		...
		},
		{
			...
			source:
				"Publisher: MDPI Country of Publication: Switzerland NLM ID: 101238455 Publication Model: Electronic Cited Medium: Internet ISSN: 1660-4601 (Electronic) Linking ISSN: 16604601 NLM ISO Abbreviation: Int J Environ Res Public Health Subsets: In Process; MEDLINE",
			authors: [
				"Liotta G",
				"Marazzi MC",
				"Mothibi KE",
			...
			publicationDate: new Date("2015-10-21T00:00:00.000Z"),
			languages: ["English"],
		...
		},
		{
			...
			publicationDate: new Date("2014-05-01T00:00:00.000Z"),
			languages: ["English"],
			database: "ERIC",
			subjects: [
				"Foreign Countries",
			...
			publicationType: "Numerical/Quantitative Data; Reports - Evaluative",
			abstract:
		...
		},
		{
			...
			source:
				"Journal of Youth and Adolescence. April 2015, Vol. 44 Issue 4, p847, 13 p.",
			authors: ["Boyes, Mark E.", "Cluver, Lucie D."],
			publicationDate: new Date("2015-04-01T00:00:00.000Z"),
			languages: ["English"],
			database: "Academic OneFile",
			subjects: [
		...
		},
		{
			...
			exportLinks: {},
			doi: "10.1016/j.jana.2015.01.002",
			title:
			...
			source:
				"In Journal of the Association of Nurses in AIDS Care July-August 2015 26(4):432-442",
			authors: ["Thornton, Clifton P.", "Veenema, Tener Goodwin"],
			publicationDate: new Date("2015-07-01T00:00:00.000Z"),
			languages: ["English"],
		...
		},
		{
			...
			AvailableFacetValues: [
				...
				},
				{
					...
					Count: 410,
					AddAction: "addfacetfilter(SubjectEDS:sexually transmitted diseases)",
				},
				{
			...
			AvailableFacetValues: [
				{
					...
					Count: 523,
					AddAction: "addfacetfilter(Publisher:american academy of pediatrics)",
				},
				{
				...
				},
				{
					...
					Count: 432,
					AddAction: "addfacetfilter(Publisher:lippincott williams & wilkins)",
				},
				{
				...
				},
				{
					...
					Count: 358,
					AddAction: "addfacetfilter(Publisher:oxford university press / usa)",
				},
				{
				...
				{
					Value: "west virginia university press, university of west virginia",
					Count: 2,
					AddAction:
		...
		},
		{
			...
			AvailableFacetValues: [
				...
				},
				{
					...
					Count: 166,
					AddAction: "addfacetfilter(Journal:archives of disease in childhood)",
				},
				{
		...
		},
		{
			...
			AvailableFacetValues: [
				...
				},
				{
					...
					Count: 66,
					AddAction: "addfacetfilter(ContentProvider:InfoTrac Junior Edition)",
				},
				{
				...
				},
				{
					...
					Count: 1812,
					AddAction: "addfacetfilter(ContentProvider:InfoTrac Student Edition)",
				},
				{
					Value: "J-STAGE",
					Count: 8,
				...
				},
				{
					...
					Count: 1,
					AddAction: "addfacetfilter(ContentProvider:Minority Health Archive)",
				},
				{
					Value: "Narcis",
					Count: 185,
				...
				},
				{
					...
					Count: 52,
					AddAction: "addfacetfilter(ContentProvider:SA ePublications Service)",
				},
				{
					Value: "SciELO",
					Count: 515,
				...
				},
				{
					...
					Count: 93,
					AddAction: "addfacetfilter(ContentProvider:U.S. History in Context)",
				},
				{
				...
				},
				{
					...
					Count: 76,
					AddAction: "addfacetfilter(ContentProvider:World History in Context)",
				},
			],
		},
	],
