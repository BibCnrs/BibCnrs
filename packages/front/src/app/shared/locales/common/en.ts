...
Sincerely`,
	...
	pages: {
		...
		favourite: {
			title: "My bookmarks",
			search: "Search my bookmarks",
			favourites: "My bookmarks",
			superFavourites: "My pinned bookmarks",
			sharedFavourites: "Pinned bookmarks",
			add: "Add a personal resource",
			pin: "Pin {{url}}",
			unpin: "Unpin {{url}}",
			delete: "Delete {{url}}",
			emptyFavorites: "No bookmarks found.",
			article: "Article",
		...
		userSettings: {
			...
			homeSection: {
				...
				displayFavorites: "Pinned bookmarks",
			...
			searchSection: {
				...
				oa: "Open Access",
				fullText: "Full Text",
				platformView: "Patforms page display style",
				platformViewCard: "Cards",
				platformViewList: "List",
			},
			generalSection: {
				title: "General",
